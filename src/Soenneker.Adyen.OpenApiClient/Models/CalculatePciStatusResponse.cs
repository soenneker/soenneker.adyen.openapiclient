...
namespace Soenneker.Adyen.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public static global::Soenneker.Adyen.OpenApiClient.Models.CalculatePciStatusResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Adyen.OpenApiClient.Models.CalculatePciStatusResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "signingRequired", n => { SigningRequired = n.GetBoolValue(); } },
            };
        }
        /// <summary>
