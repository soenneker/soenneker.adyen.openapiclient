...
namespace Soenneker.Adyen.OpenApiClient.Models
{
    ...
    public partial class DefenseReasonsResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The defense reasons that can be used to defend the dispute.</summary>
...
#nullable restore
        ...
        public static global::Soenneker.Adyen.OpenApiClient.Models.DefenseReasonsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Adyen.OpenApiClient.Models.DefenseReasonsResponse();
        }
        /// <summary>
