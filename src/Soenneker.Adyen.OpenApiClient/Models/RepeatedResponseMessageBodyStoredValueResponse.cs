...
namespace Soenneker.Adyen.OpenApiClient.Models
{
    ...
    public partial class RepeatedResponseMessageBodyStoredValueResponse : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResponseSaleData? SaleData { get; set; }
#nullable restore
#else
        public global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResponseSaleData SaleData { get; set; }
#endif
        /// <summary>Result of loading/reloading a stored value card.If StoredValueResponse.Result is Success or Partial, one entry per StoredValueRequest.StoredValueData loaded or activated.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResult>? StoredValueResult { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResult> StoredValueResult { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Adyen.OpenApiClient.Models.RepeatedResponseMessageBodyStoredValueResponse"/> and sets the default values.
        /// </summary>
        public RepeatedResponseMessageBodyStoredValueResponse()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Adyen.OpenApiClient.Models.RepeatedResponseMessageBodyStoredValueResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Adyen.OpenApiClient.Models.RepeatedResponseMessageBodyStoredValueResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Adyen.OpenApiClient.Models.RepeatedResponseMessageBodyStoredValueResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "SaleData", n => { SaleData = n.GetObjectValue<global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResponseSaleData>(global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResponseSaleData.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Adyen.OpenApiClient.Models.StoredValueResponseSaleData>("SaleData", SaleData);
