...
#nullable restore
        ...
        public global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_communicationFormat? CommunicationFormat { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_encryptionProtocol? EncryptionProtocol { get; set; }
        /// <summary>&quot;Network type for Terminal API notification webhooks. Possible values:* **public*** **local**Default Value: **public**.&quot;</summary>
        public global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_networkType? NetworkType { get; set; }
...
#nullable restore
        ...
        public static global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "communicationFormat", n => { CommunicationFormat = n.GetEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_communicationFormat>(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "encryptionProtocol", n => { EncryptionProtocol = n.GetEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_encryptionProtocol>(); } },
                { "networkType", n => { NetworkType = n.GetEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_networkType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_communicationFormat>("communicationFormat", CommunicationFormat);
            writer.WriteStringValue("description", Description);
            writer.WriteEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_encryptionProtocol>("encryptionProtocol", EncryptionProtocol);
            writer.WriteEnumValue<global::Soenneker.Adyen.OpenApiClient.Models.UpdateMerchantWebhookRequest_networkType>("networkType", NetworkType);
