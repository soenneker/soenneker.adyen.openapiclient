...
using Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.Item;
...
using System;
namespace Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices
{
    /// <summary>
    /// Builds and executes requests for operations under \BalancePlatformService-v2\scaDevices
    /// </summary>
    ...
    public partial class ScaDevicesRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.Item.WithDeviceItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.Item.WithDeviceItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.ScaDevicesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScaDevicesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/BalancePlatformService-v2/scaDevices", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.ScaDevicesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScaDevicesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/BalancePlatformService-v2/scaDevices", rawUrl)
        {
        }
        /// <summary>
        /// Begins the registration process for a new Strong Customer Authentication (SCA) device.
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationResponse?> PostAsync(global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationResponse> PostAsync(global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationResponse>(requestInfo, global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Begins the registration process for a new Strong Customer Authentication (SCA) device.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Adyen.OpenApiClient.Models.BeginScaDeviceRegistrationRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.ScaDevicesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.ScaDevicesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Adyen.OpenApiClient.BalancePlatformServiceV2.ScaDevices.ScaDevicesRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
