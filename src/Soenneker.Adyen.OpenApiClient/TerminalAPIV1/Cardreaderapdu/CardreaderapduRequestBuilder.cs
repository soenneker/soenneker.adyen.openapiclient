...
using System;
namespace Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu
{
    /// <summary>
    /// Builds and executes requests for operations under \TerminalAPI-v1\cardreaderapdu
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CardreaderapduRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu.CardreaderapduRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CardreaderapduRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/TerminalAPI-v1/cardreaderapdu", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu.CardreaderapduRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CardreaderapduRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/TerminalAPI-v1/cardreaderapdu", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu.CardreaderapduRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu.CardreaderapduRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Adyen.OpenApiClient.TerminalAPIV1.Cardreaderapdu.CardreaderapduRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
